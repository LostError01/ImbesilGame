...
public class Enemy3 : MonoBehaviour
{
    ...
    public string Horizontal = "R_Horizontal";
    public string Vertical = "R_Vertical";
    public string Walking = "R_Walking";
    ...
    private void Start()
    {
        ...
        if (EnemyManager3.Instance.enemigosDestruidos.Contains(idEnemigo) && Movimiento.Perder == false)
        {
            Destroy(gameObject);
        }
    }
    ...
    public void OnDestroy()
    {
        ...
        {
            EnemyManager3.Instance.enemigosDestruidos.Add(idEnemigo);
        }
